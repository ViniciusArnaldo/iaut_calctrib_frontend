...
export const SubscriptionsPage: React.FC = () => {
  ...
  return (
    <DashboardLayout>
      <div>
        <h1 className="text-2xl font-bold text-gray-900 mb-6">Assinaturas e Planos</h1>
          ...
          <Card className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div>
                ...
                <p className="text-lg font-bold text-gray-900">{usage.plano}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Cálculos Realizados</p>
                <p className="text-lg font-bold text-gray-900">{usage.calculosRealizados}</p>
              </div>
              <div>
